        ...
        <Container>
          ...
          <Navbar.Collapse id="basic-navbar-nav">
            ...
            >
              ...
              <Button variant="primary" onClick={(e) => loginWithRedirect()} > 
                <AccountBoxIcon /> Google Login
              </Button>
              {/* <Button variant="primary" onClick={(e) => logout()} > 
                <AccountBoxIcon /> Logout
              </Button> */}
              <Button variant="primary" onClick={GotoMain}>
                Register
              </Button>
             
              {/* <Button variant="primary" onClick={RegisterData}>
           UserData
              </Button> */}
            </Navbar.Brand>
          </Navbar.Collapse>
